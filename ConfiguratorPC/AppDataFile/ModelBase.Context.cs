...
namespace ConfiguratorPC.AppDataFile
{
    ...
    {
        private static configuratorPCEntities _context;
        public configuratorPCEntities()
            : base("name=configuratorPCEntities")
        {
        }

        public static configuratorPCEntities GetContext()
        {
            if (_context == null)
                _context = new configuratorPCEntities();
        ...
        public virtual DbSet<add_ssd> add_ssd { get; set; }
        ...
        public virtual DbSet<cool_system> cool_system { get; set; }
        ...
        public virtual DbSet<type_memory> type_memory { get; set; }
